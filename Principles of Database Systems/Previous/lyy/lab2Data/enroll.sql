create table enroll (sid int, grade float, dname varchar(50), cno int, sectno int,primary key(sid,dname,cno,sectno),foreign key(sid)references student,foreign key(dname,cno,sectno)references section);
