...
## The file contains a declaration of the icodes for lealX (ILEAL).
...
quote 'byte_t address_cal;'
quote 'int NO_LEAL = 100;'
...
intsig IPOPL	'I_POPL'
# Instruction code for lealX instruction
intsig ILEAL    'I_LEAL'
...
#### Output of the addressing unit #################################
intsig AddrVal 'address_cal' #address value
...
bool need_valC =
	f_icode in { IIRMOVL, IRMMOVL, IMRMOVL, IJXX, ICALL, ILEAL };
...
int d_srcA = [
	D_icode in { IRRMOVL, IRMMOVL, IOPL, IPUSHL, ILEAL } : D_rA;
...
int d_srcB = [
	D_icode in { IOPL, IRMMOVL, IMRMOVL, ILEAL } : D_rB;
...
int d_dstE = [
	D_icode in { IRRMOVL, IIRMOVL, IOPL, ILEAL } : D_rB;
	D_icode in { IPUSHL, IPOPL, ICALL, IRET } : RESP;
...
int aluA = [
	E_icode in { IRRMOVL, IOPL, ILEAL  } : E_valA;
	E_icode in { IIRMOVL, IRMMOVL, IMRMOVL} : E_valC; ##constant value
...
int aluB = [
	E_icode in { IRMMOVL, IMRMOVL, IOPL, ICALL, 
		     IPUSHL, IRET, IPOPL, ILEAL } : E_valB;
	E_icode in { IRRMOVL, IIRMOVL } : 0;
	# Other instructions don't need ALU
];

int aluC = [
        E_icode in { ILEAL } : E_valC;
	1 : 0;
];

## Set the ALU function
int alufun = [
	E_icode in { IOPL, ILEAL } : E_ifun;
	1 : ALUADD;
 ];
