/* Instruction Set definition for Y85 Architecture */
/* Revisions:
   2009-03-11:
...
typedef enum { R_ARG, M_ARG, I_ARG, NO_ARG, L_ARG } arg_t; //added L_ARG for leal

/* Different instruction types */
typedef enum { I_HALT, I_NOP, I_RRMOVL, I_IRMOVL, I_RMMOVL, I_MRMOVL,
	       I_ALU, I_JMP, I_CALL, I_RET, I_PUSHL, I_POPL,
	       I_IADDL, I_LEAVE, I_POP2, I_LEAL } itype_t;


/* Different ALU operations */
typedef enum { A_ADD =10, A_SUB, A_AND, A_XOR, A_NONE, LEAL1=0, LEAL2=1, LEAL4=2, LEAL8=3, LEAL0=0xF} alu_t;
