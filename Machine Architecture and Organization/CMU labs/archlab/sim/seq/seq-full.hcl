...
## Your task is to implement the lealX instruction
## where X is either 0, 1, 2, 4 or 8.
## The file contains a declaration of the icode for leal (ILEAL).
...
intsig IPOPL	'I_POPL'
# Instruction code for leal instruction
intsig ILEAL    'I_LEAL'
...
bool instr_valid = icode in 
	{ INOP, IHALT, IRRMOVL, IIRMOVL, IRMMOVL, IMRMOVL,
	       IOPL, IJXX, ICALL, IRET, IPUSHL, IPOPL, ILEAL };

# Does fetched instruction require a regid byte?
bool need_regids =
	icode in { IRRMOVL, IOPL, IPUSHL, IPOPL, 
		     IIRMOVL, IRMMOVL, IMRMOVL, ILEAL };

# Does fetched instruction require a constant word?
bool need_valC =
	icode in { IIRMOVL, IRMMOVL, IMRMOVL, IJXX, ICALL, ILEAL };

################ Decode Stage    ###################################

## What register should be used as the A source?
int srcA = [
	icode in { IRRMOVL, IRMMOVL, IOPL, IPUSHL, ILEAL } : rA;
...
int srcB = [
	icode in { IOPL, IRMMOVL, IMRMOVL, ILEAL } : rB;
...
int dstE = [
	...
	icode in { IIRMOVL, IOPL, ILEAL} : rB;
	icode in { IPUSHL, IPOPL, ICALL, IRET } : RESP;
...
int aluA = [
	icode in { IRRMOVL, IOPL, ILEAL } : valA;
...
int alufun = [
	icode in { IOPL, ILEAL } : ifun;
	1 : ALUADD;
];

## Should the condition codes be updated?
bool set_cc = icode == IOPL;
